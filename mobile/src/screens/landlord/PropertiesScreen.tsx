  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text variant="headlineSmall" style={styles.title}>Properties</Text>
      </View>
      <Card style={styles.card}>
        <Card.Content>
          <Text variant="bodyMedium" style={styles.placeholder}>Properties list will be loaded from API</Text>
        </Card.Content>
      </Card>
    </ScrollView>
  );
