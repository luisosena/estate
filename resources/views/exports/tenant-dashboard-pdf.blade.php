...
<head>
    ...
    <style>
        ...
        .info-item { display: inline-block; background: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 10px 14px; min-width: 140px; margin: 0 8px 8px 0; vertical-align: top; }
