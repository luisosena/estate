...
interface TenantEditModalProps {
    ...
    editType?: 'personal' | 'emergency' | 'tenancy' | 'unit' | 'property';
}

export default function TenantEditModal({ isOpen, onClose, tenant, tenancy, unit, property, onSave, editType = 'personal' }: TenantEditModalProps) {
    ...
    const getModalTitle = () => {
        switch (editType) {
            ...
            case 'tenancy': return 'Edit Tenancy Information';
            case 'unit': return 'Edit Unit Information';
            case 'property': return 'Edit Property Information';
