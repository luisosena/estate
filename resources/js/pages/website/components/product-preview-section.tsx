...
function FeatureRow({ eyebrow, headline, description, points, isReversed, bgColor, mockup }: FeatureProps) {
    ...
    return (
        <div ref={ref} className={cn("py-24 border-b border-[#1A1A2E]/5 last:border-0", bgColor)}>
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className={cn("flex flex-col gap-16 lg:items-center", isReversed ? "lg:flex-row-reverse" : "lg:flex-row")}>
                    ...
                    >
                        <span 
                            className="text-xs font-bold tracking-widest text-[#D4A853] uppercase"
                            style={{ fontFamily: "'Outfit', sans-serif" }}
                        >
                            {eyebrow}
                        </span>
                        <h3 
                            className="mt-4 text-3xl font-normal text-[#1A1A2E] sm:text-4xl leading-tight"
                            style={{ fontFamily: "'DM Serif Display', serif" }}
                        >
                            {headline}
                        </h3>
                        <p 
                            className="mt-6 text-lg text-[#1A1A2E]/60 leading-relaxed"
                            style={{ fontFamily: "'Outfit', sans-serif" }}
                        >
                            {description}
                        </p>
                        ...
                        <ul className="mt-8 space-y-4">
                            {points.map((point, i) => (
                                <li key={i} className="flex items-start gap-3">
                                    <div className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#8BA888]/15">
                                        <svg className="h-3 w-3 text-[#8BA888]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                        </svg>
                                    </div>
                                    <span 
                                        className="text-[#1A1A2E]/80 font-medium"
                                        style={{ fontFamily: "'Outfit', sans-serif" }}
                                    >
                                        {point}
                                    </span>
                    ...
                    >
                        <div className="relative mx-auto max-w-[600px]">
                            ...
                            <div className="overflow-hidden rounded-xl border border-[#1A1A2E]/10 bg-white shadow-2xl shadow-[#1A1A2E]/10">
                                ...
                                {/* Mockup content */}
                                <div className="bg-[#FAF7F2]/30 p-6 h-[380px] overflow-hidden">
                                    {mockup}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <div className="flex gap-2">
                                <div className="h-6 w-20 rounded border border-[#1A1A2E]/10" />
                                <div className="h-6 w-20 rounded bg-[#1A1A2E] text-white" />
                            </div>
                        </div>
                        ...
                        <div className="flex-1 rounded-lg border border-[#1A1A2E]/5 bg-white p-4 shadow-sm">
                            ...
                            <div className="flex flex-col gap-3">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="flex items-center justify-between border-b border-[#1A1A2E]/5 pb-3">
                                        <div className="flex items-center gap-3">
                                            <div className="h-8 w-8 rounded bg-[#1A1A2E]/5" />
                                            <div>
                                                <div className="h-2.5 w-32 rounded bg-[#1A1A2E]/20 mb-1.5" />
                                                <div className="h-2 w-20 rounded bg-[#1A1A2E]/10" />
                                            </div>
                                        </div>
                                        <div className="h-4 w-12 rounded-full bg-[#8BA888]/15" />
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="rounded-lg border border-[#1A1A2E]/5 bg-white p-5 shadow-sm relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                <div className="h-10 w-10 rounded-full bg-[#8BA888]/20 flex items-center justify-center">
                                    <div className="h-5 w-5 rounded-full bg-[#8BA888]" />
                                </div>
                                <div>
                                    <div className="h-3 w-24 rounded bg-[#1A1A2E]/20 mb-1" />
                                    <div className="h-2 w-16 rounded bg-[#8BA888]/40" />
                                </div>
                            </div>
                            <div className="h-8 w-40 rounded bg-[#1A1A2E]/5 mb-6" />
                            <div className="flex justify-between items-center border-t border-[#1A1A2E]/5 pt-4">
                                <div className="h-3 w-20 rounded bg-[#1A1A2E]/10" />
                                <div className="h-6 w-24 rounded bg-[#D4A853]/10" />
                            </div>
                        </div>
            ...
            <FeatureRow 
                ...
                mockup={
                    <div className="flex flex-col gap-3 h-full">
                        <div className="flex gap-2 border-b border-[#1A1A2E]/10 pb-2">
                            <div className="px-3 py-1 text-[10px] font-bold rounded bg-[#1A1A2E] text-white">Open (3)</div>
                            <div className="px-3 py-1 text-[10px] font-bold rounded bg-transparent text-[#1A1A2E]/40">In Progress (1)</div>
                            <div className="px-3 py-1 text-[10px] font-bold rounded bg-transparent text-[#1A1A2E]/40">Resolved</div>
                        </div>
                            ...
                            <div key={i} className="rounded border border-[#1A1A2E]/5 bg-white p-3 shadow-sm flex gap-3">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start mb-1">
                                        <div className="text-[11px] font-bold text-[#1A1A2E]">{issue.title}</div>
                                    ...
                                    <div className="text-[9px] text-[#1A1A2E]/50 mb-2">{issue.unit} • Reported 2h ago</div>
                                    <div className="h-1.5 w-full bg-[#1A1A2E]/5 rounded-full overflow-hidden">
