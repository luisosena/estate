...
import { Bell, Check, CheckCheck, Filter, Trash2, X, AlertCircle, Info } from 'lucide-react';
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <Card className="border-border/50 shadow-none bg-muted/20">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Total History</CardTitle>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Select value={localFilters.type} onValueChange={(value) => handleFilterChange('type', value)}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="App\Notifications\TenancyExpiringNotification">Expiring Leases</SelectItem>
                                <SelectItem value="App\Notifications\TenancyEndedNotification">Ended Tenancies</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <CardDescription>
                          {notificationList.length === 0 
                            ...
                            : `Reviewing ${notificationList.length} recent system events`
                          }
                        </CardDescription>
                    </div>
                </div>
                        ...
                        <div className="flex items-start gap-4 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-4 mt-2.5">
                              ...
                              {notification.data.tenant_code && (
                                <Link
                                  href={route('landlord.tenants.show', {
                                    tenant: notification.data.tenant_code
                                  })}
