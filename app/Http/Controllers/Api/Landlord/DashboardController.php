...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $recentPayments = Payment::whereHas('tenancy.unit.property', function ($query) use ($landlord) {
            ...
            ->with('tenancy.unit:id,unit_number,property_id')
            ...
            ->map(function ($payment) {
                ...
                return [
                    ...
                    'unit_number' => $payment->tenancy?->unit?->unit_number,
        ...
        $expiringLeases = Tenancy::whereHas('unit.property', function ($query) use ($landlord) {
            ...
            ->with(['tenant:id,full_name,email', 'unit:id,unit_number,property_id'])
